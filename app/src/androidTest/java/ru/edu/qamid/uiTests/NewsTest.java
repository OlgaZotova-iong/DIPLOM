...
public class NewsTest {
    ...
    public void testExpandAndCollapseNewsList() {
        newsPage.waitForNewsScreenLoaded();
    ...
    public void testPullToRefreshOnMain() {
        newsPage.waitForNewsScreenLoaded();
    ...
    @Description("TC-013: Открытие главного меню")
    ...
    public void testMultiplePullToRefresh() {
        newsPage.waitForNewsScreenLoaded();
        for (int i = 0; i < 5; i++) {
            newsPage.pullToRefreshOnMainScreen();
        }
    ...
    public void testNavigateToQuotes() {
        newsPage.waitForNewsScreenLoaded();
